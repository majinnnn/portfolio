...
import Poster from "../../public/img/video.mp4";
      ...
      <div className="main-text-container">
        ...
        {leftImg && (
          <img
            ...
            src={`${leftImgSrc ? leftImgSrc : "img/displaypic0.jpg"}`}
            alt=""
          />
        )}
        <div className="main-text" id="selector">
          ...
          <AnimationText />
          <p>
            {`I'm`} a motivated individual with passion & knowledge of languages and development
            tools, based in Lahore, Pakistan. I strive to build immersive and beautiful web applications
