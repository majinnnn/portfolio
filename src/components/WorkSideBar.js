...
export const SliderSideBar = ({ sliderImages }) => {
  return (
    <div
      id="slider"
    ...
    >
      ...
      >
        <Carousel.Item className="carousel-item" interval={2000}>
          <img src={sliderImages.img1} alt="slide 1" />
        </Carousel.Item>
        <Carousel.Item className="carousel-item" interval={2000}>
          <img src={sliderImages.img2} alt="slide 2" />
        </Carousel.Item>
        <Carousel.Item className="carousel-item" interval={2000}>
          <img src={sliderImages.img3} alt="slide 3" />
        </Carousel.Item>
        <Carousel.Item className="carousel-item" interval={2000}>
          <img src={sliderImages.img4} alt="slide 4" />
        </Carousel.Item>
      </Carousel>
    </div>
  );
