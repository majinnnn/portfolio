...
const menus = [
  ...
  { icon: "fa fa-lightbulb-o", dkMenuName: "Inspirations", name: "my inspirers", id: "inspirations" },
  { icon: "fa fa-star", dkMenuName: "Remarks", name: "remarks", id: "remarks" },
];

const Header = ({ light }) => {
  const [toggle, setToggle] = useState(false);
  const { changeNav, nav, changeMobileMenu, mobileMenu } = useContext(NavContext);
  useEffect(() => {
